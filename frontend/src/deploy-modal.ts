      ...
      <md-dialog>
        ...
        <div slot="content" class="content">
          ...
          <div class="cta-container">
            <a class="deploy-btn" href="https://deploy.cloud.run/?utm_source=github&utm_medium=unpaidsoc&utm_campaign=FY-Q1-global-cloud-ai-starter-apps&utm_content=take3bounce&utm_term=-" target="_blank" @click=${() => this.dialog.close()}>
